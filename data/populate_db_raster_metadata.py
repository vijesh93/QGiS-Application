...
Scan data folder for .tif files.
Check if they are already optimized (COGs); if not, it creates a new optimized version.
Extract the bounding box (BBOX) and projection (SRID).
Insert all this into your layer_metadata table.
"""
